...
# Скрипты
backup_item "$HOME/alacritty-start.sh" "Alacritty scripts"
backup_item "$HOME/start-zellij-choose.sh" "Zellij scripts"
backup_item "$HOME/start-vpn-manage.sh" "Project scripts"

# macOS specific
backup_item "$HOME/Library/Application Support/Code/User/settings.json" "VSCode settings"
backup_item "$HOME/.config/karabiner" "Karabiner config"
